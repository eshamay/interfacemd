...
class histogram_analyzer : public XYZAnalysisSet {
	public:
		histogram_analyzer (std::string desc, std::string fn) : XYZAnalysisSet (desc,fn) { }
...
class double_histogram_analyzer : public histogram_analyzer {
	public:
		double_histogram_analyzer (std::string desc, std::string fn) : histogram_analyzer (desc,fn) { }
...
class h2o_angle_bond_histogram_analyzer : public double_histogram_analyzer {
	public:
...
class h2o_dipole_magnitude_histogram_analyzer : public histogram_analyzer {
	public:
